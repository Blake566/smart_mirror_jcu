...
class _HomePageState extends State<RegistrationScreen> {
  ...
  doFaceDetection() async {
    ...
    for (Face face in faces) {
      final Rect boundingBox = face.boundingBox; // Location of the face
      print('Rect = ' + boundingBox.toString());

      num left = boundingBox.left < 0 ? 0 : boundingBox.left;
      num top = boundingBox.top < 0 ? 0 : boundingBox.right;
      num right =
      ...
      //final check making sure that boundingbox not over the size of image.
          ...
          child: Stack(
            children: [
              BackdropFilter(
                ...
                child: Container(
                  color: Colors.white
                      .withOpacity(0.5), // Adjust the blur color and opacity
                ),
              ),
              Positioned.fill(
                child: Center(
                  ...
                  image != null
                      ...
                      Container(
                          ...
                          margin: const EdgeInsets.only(
                              top: 140, left: 30, right: 30, bottom: 0),
                          child: FittedBox(
                            child: SizedBox(
              ...
              // Circle in the middle with cutout effect
            ],
          )),
    );
  }
